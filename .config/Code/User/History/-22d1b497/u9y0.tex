...
\begin{enumerate}
    ...
    \end{itemize} \begin{solution}
        ...
        ahora que tenemos la función tenemos que maximizarla por lo que calculamos $x$ 
        \[x = \frac{-b}{2a} = \frac{-1375000}{-5000} = 275\]
        y el ingreso máximo lo obtenemos al sustituir en la función
        \[i_x = -2500(275)^2+1375000(275)+75000000 = 264062500\]
        el ingreso máximo es de \$264062500
    \end{solution}
\end{enumerate}
