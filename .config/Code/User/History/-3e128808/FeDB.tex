...
\begin{enumerate}
    ...
    \item \[f(x) = \frac{x}{x+8}\] \begin{solution}
        ...
        para el rango despejamos a la $x$ y hacemos $f(x)=y$
        \[y = \frac{x}{x+8} \Rightarrow y(x+8) = x \Rightarrow yx-x+8y=0 \Rightarrow x(y-1) = -8y\]
        \[x = \frac{-8y}{y-1}\]
        ahora resolvemos para el denominador y obtenemos
        \[y-1 = 0 \Rightarrow y = 1\]
        por lo que el rango no puede tomar el valor de $(1)$ como se observa en la grafica
        \begin{figure}[H]
            \centering
            \includegraphics[width = 0.5\textwidth]{figura6.png}
        \end{figure}
        de modo que el rango es
        \[Ran_f = (-\infty,1)\cup(1,\infty)\]
    \end{solution}
\end{enumerate}
