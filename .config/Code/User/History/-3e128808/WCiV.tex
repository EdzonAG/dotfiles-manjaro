...
\begin{enumerate}
    \item \begin{solution}
        Para el dominio primero por ser una función racional entonces el denominador tiene que ser distinto de cero, así que busquemos los valores para los cuales \[x^2-x-4 \neq 0\]
    \end{solution}
\end{enumerate}
