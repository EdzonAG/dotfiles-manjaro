...
\begin{enumerate}
    ...
    \item \[g(t) = \sqrt{2t-1}\]\begin{solution}
        ...
        para obtener el rango podemos despejar a $t$ y haciendo $g(t) = y$ para calcular de nuevo el dominio de la nueva función
        \[y = \sqrt{2t-1} \Rightarrow y^2 = 2t-1 \Rightarrow y^2+1 = 2t \Rightarrow t = \frac{y^2+1}{2}\]
    \end{solution}
\end{enumerate}
