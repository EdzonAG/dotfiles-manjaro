...
title = Label(data, text= 'AXTY Technology').grid(padx=10, pady=10, row=0, column=0,columnspan=4,sticky=N)
subtitle = Label(data, text= 'Ficha Técnica').grid(padx=10, pady=10, row=1, column=0,columnspan=4,sticky=N)
...
subtitle2 = Label(data, text= 'Datos del Cliente').grid(padx=10, pady=10, row=3, column=0,columnspan=4,sticky=N+S)
