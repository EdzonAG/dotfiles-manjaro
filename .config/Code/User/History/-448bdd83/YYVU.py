...
title = Label(data, text= 'AXTY Technology').grid(row=0, column=0,columnspan=4,sticky=N+S)
subtitle = Label(data, text= 'Ficha Técnica').grid(row=1, column=0,columnspan=4,sticky=N+S)
...
label_client = Label(data, text='Nombre Cliente:').grid(padx=5, row=4, column=0, columnspan=2, sticky=W+E)
entry_client = Entry(data, textvariable=client).grid(padx=5, row=4, column= 2, columnspan=2, sticky=W+E)

label_email = Label(data, text='Correo:').grid(padx=5, row=5, column=0, sticky=W+E)
entry_email = Entry(data, textvariable=email).grid(padx=5, row=5, column= 1, sticky=W+E)
