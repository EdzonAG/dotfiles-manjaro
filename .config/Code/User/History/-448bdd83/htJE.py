...
entry_disk = Entry(data, textvariable=capacity).grid(padx=10, pady=10, row=10, column= 1, sticky=E)
label_GB1 = Label(data, text='GB').grid(padx=10, pady=10, row=10, column=2, sticky=E)
