...
#Marca y Modelo Fila 9
label_marca = Label(data, text='Marca:').grid(padx=10, pady=10, row=8, column=0, sticky=W+E)
entry_marca = Entry(data, textvariable=brand).grid(padx=10, pady=10, row=8, column= 1, sticky=W+E)
...
#Procesador y Almacenamiento Fila 10
label_cpu = Label(data, text='CPU:').grid(padx=10, pady=10, row=9, column=0, sticky=W+E)
entry_cpu = Entry(data, textvariable=cpu).grid(padx=10, pady=10, row=9, column= 1, sticky=W+E)

label_disk = Label(data, text='Almacenamiento:').grid(padx=10, pady=10, row=10, column=0, sticky=W+E)
entry_disk = Entry(data, textvariable=capacity).grid(padx=10, pady=10, row=10, column= 1, sticky=W+E)
label_GB1 = Label(data, text='GB').grid(padx=10, pady=10, row=10, column=2, sticky=W)
menu_disk = OptionMenu(data, disk, 'Disco Duro HDD', 'Unidad Solida SSD').grid(padx=10, pady=10, row=10, column= 3, sticky=W)

#Memoria RAM Fila 11
label_memory = Label(data, text='Memoria RAM:').grid(padx=10, pady=10, row=11, column=0,columnspan=2, sticky=W+E)
entry_memory = Entry(data, textvariable=memory).grid(padx=10, pady=10, row=11, column= 2, sticky=W+E)
label_GB = Label(data, text='GB').grid(padx=10, pady=10, row=11, column=3, sticky=W)
