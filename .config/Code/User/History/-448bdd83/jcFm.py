...
label_email = Label(data, text='Correo:').grid(padx=5, pady=5, row=5, column=0, sticky=W+E)
entry_email = Entry(data, textvariable=email).grid(padx=5, pady=5, row=5, column= 1, sticky=W+E)
