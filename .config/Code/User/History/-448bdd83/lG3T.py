...
label_memory = Label(data, text='Memoria RAM:').grid(padx=10, pady=10, row=9, column=2, sticky=W+E)
entry_memory = Entry(data, textvariable=memory).grid(padx=10, pady=10, row=9, column= 3, sticky=W+E)
