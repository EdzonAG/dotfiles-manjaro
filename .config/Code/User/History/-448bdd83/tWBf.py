...
label_disk = Label(data, text='Almacenamiento:').grid(padx=10, pady=10, row=10, column=0,columnspan=2, sticky=W+E)
entry_disk = Entry(data, textvariable=capacity).grid(padx=10, pady=10, row=10, column= 2, sticky=E+W)
menu_disk = OptionMenu(data, disk, 'GB Disco Duro HDD', 'GB Unidad Solida SSD', 'GB M.2 SSD').grid(padx=10, pady=10, row=10, column= 3, sticky=W)
...
menu_memory = OptionMenu(data, ramtype, 'GB DDR3', 'GB DDR4', 'GB DDR5').grid(padx=10, pady=10, row=11, column= 3, sticky=W)
