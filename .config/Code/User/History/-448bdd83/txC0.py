...
label_disk = Label(data, text='Tipo de Almacenamiento:').grid(padx=10, pady=10, row=9, column=2, sticky=W+E)
entry_disk = OptionMenu(data, disk, 'Disco Duro HDD', 'Unidad Solida SSD').grid(padx=10, pady=10, row=9, column= 3, sticky=W+E)

#Memoria RAM Fila 11
label_memory = Label(data, text='Memoria RAM:').grid(padx=10, pady=10, row=10, column=1,columnspan=2, sticky=W+E)
entry_memory = Entry(data, textvariable=memory).grid(padx=10, pady=10, row=10, column= 3, sticky=W+E)
label_GB = Label(data, text='GB').grid(padx=10, pady=10, row=10, column=4, sticky=W+E)
