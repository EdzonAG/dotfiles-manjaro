...
\begin{enumerate}
    ...
    \begin{table}[h]
        ...
        \cline{2-5}
                                                & \begin{tabular}[c]{@{}c@{}}Tazas \\ de Azucar\end{tabular} & \begin{tabular}[c]{@{}c@{}}Unidades \\ de Huevo\end{tabular} & \begin{tabular}[c]{@{}c@{}}Leche \\ en Litros\end{tabular} & \begin{tabular}[c]{@{}c@{}}Número \\ de Porciones\end{tabular} \\ \hline
